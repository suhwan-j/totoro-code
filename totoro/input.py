...
_BG_BLUE = (
    "\033[48;2;86;160;240m\033[38;2;13;17;23m"  # #56A0F0 bg, #0D1117 text
)
_BG_AMBER = (
    "\033[48;2;245;178;64m\033[38;2;13;17;23m"  # #F5B240 bg, #0D1117 text
)
_BG_IVORY = (
    "\033[48;2;212;186;142m\033[38;2;13;17;23m"  # #D4BA8E bg, #0D1117 text
)
MODE_THEME = {
...
class InputHandler:
    ...
    def mode_top_bar(self) -> str:
        ...
        bg_style, line_color, line_char = MODE_THEME.get(
            self.mode, (_BG_BLUE, _DIM, "─")
        )
        ...
        pad = width - tag_len
        return (
            f"{line_color}{line_char * max(0, pad)}"
            f"{_RESET} {bg_style}{label}{_RESET}"
            f" {line_color}{line_char * 2}{_RESET}"
        )
    ...
    def mode_bottom_bar(self) -> str:
        ...
        width = shutil.get_terminal_size().columns
        _, line_color, line_char = MODE_THEME.get(
            self.mode, (_BG_BLUE, _DIM, "─")
        )
    ...
    def prompt_html(self) -> HTML:
        ...
        line_fg = {
            ...
            "auto-approve": "#F5B240",
            "plan-only": "#D4BA8E",
        }.get(self.mode, "#60503A")
        tag_bg = {
            "default": "#56A0F0",
            "auto-approve": "#F5B240",
            "plan-only": "#D4BA8E",
        }.get(self.mode, "#56A0F0")
